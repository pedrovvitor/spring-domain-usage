package com.devsuperior.domainusage;
...
import com.devsuperior.domainusage.repositories.ClientRepository;
import com.devsuperior.domainusage.repositories.OrderItemRepository;
import com.devsuperior.domainusage.repositories.OrderRepository;
import com.devsuperior.domainusage.repositories.ProductRepository;

@SpringBootApplication
public class DomainUsageApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(DomainUsageApplication.class, args);
	}
